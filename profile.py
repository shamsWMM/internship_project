"""Multipath TCP Topology: This profile instantiates a topology in CloudLab of a server and client linked via two paths to simulate an MPTCP infrastructure. It uses the .sh files within the CloudLab directory on this GitHub repository to automate the initial setup of the experiment on the topology."""
